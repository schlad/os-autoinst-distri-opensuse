...
sub get_ipsec_3hosts_setup {
    ...
    return {
        ...
        middle_net_01 => require_field($left_net->{ipv6_cidr}, 'middle network 0 IPv6 CIDR missing from multimachine_topology'),
        middle_net_02 => require_field($right_net->{ipv6_cidr}, 'middle network 1 IPv6 CIDR missing from multimachine_topology'),
    };
}
